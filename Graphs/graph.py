...
class Graph:
    # --------------------------- nested Vertex class ---------------------------
    class Vertex:
        """Light weigth vertex structure for a graph"""
        __slots__ = '_element'

        def __int__(self, x):
            """Do not call constructor directly, User Graph's insert_vertex(x)"""
            self._element = x
    ...
    class Edge:
        ...
        def __init__(self, u, v, x):
            """Do not call the constructor directly. Use Graph's insert_edge(u, v, x)"""
            self._origin = u
            self._destination = v
            self._element = x
    ...
    def edge_count(self):
        ...
        # for undirected graphs, make sure not be double count edges
